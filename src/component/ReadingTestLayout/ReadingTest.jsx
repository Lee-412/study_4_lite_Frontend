...
export default function ReadingTest({data, testID, userId}) {
    ...
    return (
        <div className="bg-[#F8F9FA]">
          <h1 className="p-4 font-bold text-2xl">IELTS Simulation Reading test 3</h1>
          <div className="m-4 flex flex-row gap-5">
            <div className="p-4 flex flex-col w-10/12 bg-white rounded-xl border border-gray-300 gap-5">
              ...
              {data.map((item, itemIndex) => (
                <div key={itemIndex} className={`w-full flex flex-row gap-6 ${currentPassage === itemIndex + 1 ? 'block' : 'hidden'}`}>
