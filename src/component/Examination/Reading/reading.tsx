      ...
      boxShadow:'0 0 11px rgba(33,33,33,.2)'}}>
        ...
        <div className="Passage p-part1">
            ...
            <div className="passage">
              ...
              />
              <img src={previewImg1} alt="image-passage" width={240} height={200} />
            </div>
        </div>
        <div className="Passage p-part2">
            ...
            <div className="passage">
              ...
              className='input-file'
             />
              <img src={previewImg2} alt="image-passage" width={240} height={200} />
            </div>
        </div>
        <div className="Passage p-part3">
            ...
            <div className="passage">
              ...
              className='input-file'
              />
              <img src={previewImg3} alt="image-passage" width={240} height={200} />
            </div>
        </div>
